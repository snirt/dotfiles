  ...
  dependencies = {
    {
      ...
      opts = function(_, opts)
        ...
        maps.n["<Leader>fs"] = { function() require("fzf-lua").lsp_document_symbols() end, desc = "Find Symbols" }
        maps.n["<Leader>fS"] =
          { function() require("fzf-lua").lsp_live_workspace_symbols() end, desc = "Find Workspace Symbols" }
